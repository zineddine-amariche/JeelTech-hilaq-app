        ...
        {!!titleContent && (
          ...
          >
            <Text
              ...
              size="md"
              text={titleContent}
              style={[$title, $titleStyleOverride, { textAlign: "left" }]}
            />
          </View>
        )}
        ...
        {content && (
          <View style={[$actionTextContainer, { backgroundColor }]}>
            <Text
              ...
              size="md"
              text={content}
              style={[!icon ? $actionText : null, { backgroundColor }]}
            />
          </View>
        )}
        {icon && (
          <Icon
            ...
            containerStyle={[
              $actionIconContainer,
              inversed
                ? { marginRight: content ? spacing.xxs : 0 }
                : { marginLeft: content ? spacing.xxs : 0 },
            ]}
            style={
              (!isRTL && !inversed) || (isRTL && inversed)
